...
namespace HTTP
{
    ...
    public class Request
    {
        ...
        public Request( string method, string uri, WWWForm form )
        {
			...
			//ugur: changed since else throws error in U5: Cannot convert type `System.Collections.Generic.KeyValuePair<string,string>' to `System.Collections.DictionaryEntry'
